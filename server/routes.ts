...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  app.get('/api/gpt/estimates', async (req: any, res: any) => {
    console.log('=== DIRECT GPT ESTIMATES ROUTE EXECUTING ===');
  ...
  // Direct GPT invoices route - bypassing all other middleware
  app.get('/api/gpt/invoices', async (req: any, res: any) => {
    console.log('=== DIRECT GPT INVOICES ROUTE EXECUTING ===');
  ...
  // Direct GPT clients route - bypassing all other middleware  
  app.get('/api/gpt/clients', async (req: any, res: any) => {
    console.log('=== DIRECT GPT CLIENTS ROUTE EXECUTING ===');
  ...
  // Direct GPT create client route - bypassing all other middleware
  app.post('/api/gpt/clients', async (req: any, res: any) => {
    console.log('=== DIRECT GPT CREATE CLIENT ROUTE EXECUTING ===');
  ...
  // Duplicate GPT routes removed - using priority routes at top of file
